...
/** Matrix of size: 600 x 5 (row major format) */
real_t evGu[ 3000 ];
...
/** Matrix of size: 600 x 14 (row major format) */
real_t Q2[ 8400 ];
...
/** Matrix of size: 40 x 15 (row major format) */
real_t evHx[ 600 ];
...
/** Matrix of size: 12300 x 5 (row major format) */
real_t E[ 61500 ];
...
/** Matrix of size: 200 x 15 (row major format) */
real_t H10[ 3000 ];

/** Matrix of size: 215 x 215 (row major format) */
real_t H[ 46225 ];

/** Matrix of size: 40 x 215 (row major format) */
real_t A[ 8600 ];

/** Column vector of size: 215 */
real_t g[ 215 ];
